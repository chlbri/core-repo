...
exports.crudStringSChema = exports.errorSchema = exports.statesCommonSchemaCRUD = exports.actionSchemaCRUD = exports.stateFSchemaCRUD = exports.stateSchemaCRUD = void 0;
...
exports.errorSchema = (0, zod_1.union)([
    ...
    (0, zod_1.literal)('initial_exists'),
...
exports.crudStringSChema = (0, zod_1.union)([
    (0, zod_1.literal)('createMany'),
    (0, zod_1.literal)('createOne'),
    (0, zod_1.literal)('empty_states'),
    (0, zod_1.literal)('actions_internal'),
    (0, zod_1.literal)('states_internal'),
    (0, zod_1.literal)('no_checking'),
