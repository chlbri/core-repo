import { entitySchema, timestampsSchema } from './schemas/objects';
...
export declare type TimeStamps = TypeOf<typeof timestampsSchema>;
export declare type WithoutTimeStamps<T> = Omit<T, keyof TimeStamps>;
